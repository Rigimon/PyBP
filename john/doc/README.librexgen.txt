...
------------------------------------------------
First off, you must obtain and install rexgen library.  This currently is not
the easiest thing to build. It can be found here:

https://code.google.com/p/rexgen/

svn checkout http://rexgen.googlecode.com/svn/trunk/ rexgen-read-only
...
https://code.google.com/p/rexgen/wiki/QuickStart   Simply put:
   cd rexgen-read-only/src/librexgen
   cmake ..
   make install

If no errors (especially from cmake), librexgen should be installed.
